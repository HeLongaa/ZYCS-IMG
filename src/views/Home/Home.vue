  ...
  <section class="Home pt-4 sm:pt-6">
    <Alert class="pt-0 pb-2 sm:py-4">
      ...
      <AlertDescription class="p-0 text-xs sm:text-sm">
        ...
        <p>本图床 是由 <a href="https://www.vvhan.com" target="_blank" title="韩小韩博客">韩小韩博客</a> 开源项目<a
            href="https://github.com/uxiaohan/ZYCS-IMG" target="_blank" title="ZYCS-IMG">ZYCS-IMG</a>支持并由<a
            href="https://blog.helong.online" target="_blank" title="ZYCS-IMG">Helong</a>维护的文件上传项目，致力于为用户提供稳定的永久存储服务。
        </p>
